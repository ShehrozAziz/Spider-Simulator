...
namespace MalbersAnimations.SA
{
    ...
    public class MRigidbodyFPSController : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            ControlFreak2.CFCursor.lockState = LockCursor ? CursorLockMode.Locked : CursorLockMode.None;  // Lock or unlock the cursor.
            ControlFreak2.CFCursor.visible = !LockCursor;
            RestartMouseLook();
        }
        ...
        {
            RotateView();
            if (ControlFreak2.CF2Input.GetButtonDown("Jump") && !m_Jump)  m_Jump = true;
        }
