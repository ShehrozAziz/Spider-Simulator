            ...
            get
            {
                ...
                switch (GetPressed)
                {
                    case InputButton.Press:
                        ...
                        InputValue = (type == InputType.Input) ? InputSystem.GetButton(input) : ControlFreak2.CF2Input.GetKey(key);
                    ...
                    case InputButton.Down:
                        ...
                        InputValue = (type == InputType.Input) ? InputSystem.GetButtonDown(input) : ControlFreak2.CF2Input.GetKeyDown(key);
                    ...
                    case InputButton.Up:
                        ...
                        InputValue = (type == InputType.Input) ? InputSystem.GetButtonUp(input) : ControlFreak2.CF2Input.GetKeyUp(key);
