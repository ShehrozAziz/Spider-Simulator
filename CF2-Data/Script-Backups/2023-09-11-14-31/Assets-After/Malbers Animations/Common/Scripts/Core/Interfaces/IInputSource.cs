...
namespace MalbersAnimations
{
    ...
    {
        public float GetAxis(string Axis) => ControlFreak2.CF2Input.GetAxis(Axis);

        public float GetAxisRaw(string Axis) => ControlFreak2.CF2Input.GetAxisRaw(Axis);

        public bool GetButton(string button) => ControlFreak2.CF2Input.GetButton(button);

        public bool GetButtonDown(string button) => ControlFreak2.CF2Input.GetButtonDown(button);

        public bool GetButtonUp(string button) => ControlFreak2.CF2Input.GetButtonUp(button);
