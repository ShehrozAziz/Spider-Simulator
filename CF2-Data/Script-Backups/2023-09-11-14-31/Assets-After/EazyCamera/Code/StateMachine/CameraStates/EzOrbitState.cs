...
namespace EazyCamera.Legacy
{
    ...
    public class EzOrbitState : EzCameraState
    {
        ...
        {
            if (_controlledCamera.OribtEnabled && ControlFreak2.CF2Input.GetMouseButtonDown(0))
            {
            ...
            // cache the inputs
            float horz = ControlFreak2.CF2Input.GetAxis(MOUSEX);
            float vert = ControlFreak2.CF2Input.GetAxis(MOUSEY);
