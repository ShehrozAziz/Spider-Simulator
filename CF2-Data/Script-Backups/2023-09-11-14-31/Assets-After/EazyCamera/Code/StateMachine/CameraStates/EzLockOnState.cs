    ...
    public class EzLockOnState : EzCameraState
    {
        ...
        public override void HandleInput()
        {
            ...
            if (_isActive)
            {
                ...
                {
                    if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.E) || ControlFreak2.CF2Input.GetKeyDown(KeyCode.Q))
                    {
                        CycleTargets();
                    }
                }
            ...
            else if (ControlFreak2.CF2Input.GetKeyUp(KeyCode.Space) && _lockOnStyle == LockOnStyle.Hold)
            {
                _isActive = false;
                _controlledCamera.SetState(_controlledCamera.DefaultState);
            }
