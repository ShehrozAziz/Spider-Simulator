...
namespace EazyCamera.Legacy
{
    ...
    public class EzPlayerController : MonoBehaviour
    {
        ...
        private void HandleInput()
        {
            ...
            // cache the inputs
            float horz = ControlFreak2.CF2Input.GetAxis(ExtensionMethods.HORIZONTAL);
            float vert = ControlFreak2.CF2Input.GetAxis(ExtensionMethods.VERITCAL);
            ...
            // Move the Player
            _controlledPlayer.MovePlayer(moveVector.x, moveVector.z, ControlFreak2.CF2Input.GetKey(KeyCode.LeftShift));
        }
    }
}
